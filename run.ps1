...
Start-Process -FilePath "cmd" -ArgumentList "/k set PYTHONIOENCODING=utf-8 && cd /d `"d:\CUI'26\FYP\Flexa\flexa-backend`" && `"d:\CUI'26\FYP\Flexa\.venv\Scripts\python.exe`" -m uvicorn app.main:app --host 0.0.0.0 --port 8000" -WindowStyle Normal
