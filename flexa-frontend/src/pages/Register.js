      ...
      <div className="auth-container">
        ...
        <div className="auth-image-section">
          <div className="auth-image-card">
            <h2 style={{ marginBottom: 16, fontSize: 32, lineHeight: 1.2 }}>
            ...
            >
              Track your workouts, optimize your diet, and achieve your fitness
              goals with data-driven insights and AI-powered guidance.
            </p>
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              <div className="feature-tag">Smart Workout Plans</div>
              <div className="feature-tag">Nutrition Tracking</div>
              <div className="feature-tag">Progress Analytics</div>
            </div>
          </div>
        </div>
