...
start "FLEXA Backend" cmd /k "d:\CUI'26\FYP\Flexa\.venv\Scripts\python.exe" -m uvicorn app.main:app --app-dir "d:\CUI'26\FYP\Flexa\flexa-backend" --reload --host 0.0.0.0 --port 8000
