...
from app.schemas.workout import WorkoutPlanRequest, WorkoutResponse
...
async def complete_workout(
    ...
    """Mark a workout as completed and log the session."""
    session = await WorkoutService.complete_workout_session(db, current_user.id, workout_id)
